...
**Important work** comes in many forms. There are labels for [bugs](https://github.com/sholladay/children-dirs/labels/bug) and [easy](https://github.com/sholladay/children-dirs/labels/easy) vs [hard](https://github.com/sholladay/children-dirs/labels/hard) tasks. We also appreciate documentation, examples, tutorials, blogs, videos, books, and other supporting content.
